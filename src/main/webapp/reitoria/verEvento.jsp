            ...
            <c:if test="${not empty usuario}">
                <div class="container-fluid col-lg-8">
                    <nav class="navbar navbar-expand-lg navbar-light green darken-1">
                        ...
                        <a href="alterarEvento.jsp?q=${evento.URL}" class="nav-link text-white">
                                    ...
                                    <div class="modal-content">
                                        <form id="formDeletar" name="formDeletar" method="post" action="#">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="TituloModalCentralizado">Você tem certeza que deseja excluir o evento <b>${evento.nome}</b>?</h5>
