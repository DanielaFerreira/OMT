<%-- 
    Document   : alteracao_idioma
    Created on : 03/12/2019, 15:44:39
    Author     : daniela
--%>
                ...
                <nav class="navbar navbar-expand-lg navbar-light green darken-1">
                    <ul class="navbar-nav">
                      ...
                      <%
                            ...
                            IdiomaDAO fDAO = new IdiomaDAO();
                            i = fDAO.getById(Long.parseLong(request.getParameter("id")));
                        %>
                
                
                
                <div class="card px-4 py-4">
                    <form method="POST" action="/OMT/IdiomaServlet">
                        <h3 class="font-weight-bold mb-4">Alterar Idioma</h3>

                        <div class="form-row">
                            <div class="col-md-12 form-group">
                                <label for="nome">Nome</label>
                                <input name="nome" id="nome" type="text" value="<%=i.getNome()%>" class="form-control validate">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="descricao">Situação</label>
                            <textarea id="descricao" name="situacao" class="form-control validate" rows="4"><%=i.getSituacao()%></textarea>
                        <input class="form-control" id="id" type="hidden" name="id" value="<%=i.getId()%>" readonly>
