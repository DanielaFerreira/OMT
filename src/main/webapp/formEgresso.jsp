...
<html>
    <head>
        <meta charset="utf-8">
        <title>Questionário para egressos - OMT</title>
            ...
            <form id="formulario">
                ...
                <fieldset>
                    ...
                    <select id="camp" name="if">
                        ...
                        <option value="cla">Campus Lábrea</option>
                        <option value="cmau">Campus Maués</option>
                        ...
                        <option value="chum">Campus Humaitá</option>
                        <option value="cman">Campus Manacapuru</option>
                        <option value="cei">Campus Eirunepé</option>
                ...
                <fieldset>
                    ...
                    <input type="text" name="time" placeholder="Tempo de conclusão(semestres/anos)">
                ...
                <fieldset>
                    ...
                    <select>
                        ...
                        <option value="3">Não está cursando faculdade ou pós-graduação</option>
                ...
                <fieldset class="col">
                    ...
                    <select>
                        ...
                        <option value="3">Agronegócios</option>
                    ...
                    <select>
                        ...
                        <option value="3">4 a 5 salários mínimos</option>
                        <option value="4">6 a 10 salários mínimos</option>
                        <option value="5">Acima de 10 salários mínimos</option>
                    </select>
                    ...
                    <select>
                        ...
                        <option value="3">Exigência de experiência.</option>
                        <option value="4">Trabalhos ofertados fora do atual domicílio.</option>
                        <option value="5">A formação recebida não atende as exigências do mercado de trabalho.</option>
                        <option value="6">Não sente segurança para trabalhar na área.</option>
                        <option value="7">Falta emprego na área específica de formação.</option>
                        <option value="8">Escolha vocacional equivocada.</option>
                        <option value="9">Discriminação em relação ao sexo exigido para a função.</option>
                    ...
                    <select>
                        ...
                        <option value="3">Carga horária das disciplinas práticas.</option>
                        <option value="4">Pouca articulação entre as disciplinas.</option>
                        <option value="5">Carga horária de estágio insuficiente.</option>
