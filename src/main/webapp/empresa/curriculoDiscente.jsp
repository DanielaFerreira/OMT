                    ...
                    <div class=" card mb-5">
                        ...
                        <div class="card px-4 py-4">
                            <main>
                                <div id="to-pdf">
                                    <section>
                                        <h3 class="font-weight-bold mb-4">Informações do currículo</h3>
                                        <div class="row my-4">
                                    ...
                                    <hr class="my-4">
                                    <section>
                                        <h5 class="font-weight-bold mb-4">Formação acadêmica/ titulação</h5>
                                        ...
                                        <c:if test="${formacoes.size() == 0}">
                                            <h5 class="grey-text text-center my-4">
                                    ...
                                    <hr class="my-4">
                                    <section>
                                        <h5 class="font-weight-bold mb-4">Experiências profissionais</h5>
                                    ...
                                    <hr class="my-4">
                                    <section>
                                        <h5 class="font-weight-bold mb-4">Participação em projetos academêmicos</h5>
