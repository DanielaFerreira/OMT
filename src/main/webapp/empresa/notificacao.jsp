                                ...
                                <table class="table table-sm table-striped table-bordered table-hover" id="filtro">
                                    ...
                                    <tbody>
                                        <%for (Notificacao n : noti) {
                                                if (n.getStatus().equals("Não lida")) {
                                        %>

                                        <tr>
                                            <td><b><%=n.getTituloDestinatario().trim().split(" ")[0]%>  <%=n.getTituloDestinatario().trim().split(" ")[1]%>...</b></a></td>
                                            <td><b><%=n.getMensagemdoDestinatario().trim().split(" ")[0]%>  <%=n.getMensagemdoDestinatario().trim().split(" ")[1]%>...</b></td>
