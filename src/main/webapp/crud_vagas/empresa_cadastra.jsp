                            ...
                            <div class="card px-4 py-4">
                                <form id="cadastrar-trabalho" method="POST" action="/OMT/TrabalhoServlet">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="row" for="tipo">Tipo de Vínculo</label>
                                            <select class="form-control" id="tipo" name="tipo" required>
                                                <option  value="Efetivo" selected="selected" name="tipo" id="efetivo">Efetivo</option>
                                                <option value="Estágio" name="tipo" id="estagio" value="estagio">Estágio</option>
                                            </select>
