...
(function ($) {
    ...
    $.fn.fileinputLocales['pt-BR'] = {
        ...
        msgFileSecured: 'Retrições de segurança impedem a leitura do arquivo "{name}".',
        ...
        msgImageResizeError: 'Não foi possível obter as dimensõees da imagem para redimensionar.',
